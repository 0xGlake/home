      ...
      <div className={getLayoutStyle()}>
        {screenSize === SCREEN_SIZES.XL && (
          <div className="relative flex-1">
            <div
              className={`font-bold text-gray-800 font-mono whitespace-nowrap ${getTitleStyle()}`}
            >
              <motion.div
            ...
            <motion.div key={href} variants={linkVariants} whileHover="hover">
              {external ? (
                <a
                  ...
                  className="text-gray-600 hover:text-gray-200 font-mono hover:underline"
                >
                  {text}
                </a>
              ) : (
