...
const ReadingListItem: React.FC<ReadingListItemStruct> = ({
  url,
  description,
  category,
  favouritePosts,
        ...
        >
          ...
          >
            <g id="Link">
              ...
              ></rect>
              <path
                d="M14,16 L17,16 C19.2091,16 21,14.2091 21,12 L21,12 C21,9.79086 19.2091,8 17,8 L14,8"
                id="Path"
                className="stroke-white group-hover:stroke-violet-400"
                strokeWidth="2"
                strokeLinecap="round"
              ></path>
              <path
                d="M10,16 L7,16 C4.79086,16 3,14.2091 3,12 L3,12 C3,9.79086 4.79086,8 7,8 L10,8"
                id="Path"
                className="stroke-white group-hover:stroke-violet-400"
                strokeWidth="2"
                strokeLinecap="round"
